...
(LadiPageScriptV2.prototype.init = function () {
  ...
  (LadiPageScriptV2.prototype.copy = function (t) {
    return isObjectLadiPage(window.angular) &&
      isFunctionLadiPage(window.angular.copy)
      ? window.angular.copy(t)
      : isNullLadiPage(t)
      ? t
...
var Base64 = {
  ...
  equalsLadiPage = function (t, e) {
    return isObjectLadiPage(window.angular) &&
      ...
      : typeof t == typeof e && JSON.stringify(t) == JSON.stringify(e);
  },
...
(LadiPageScriptV2.prototype.loadHtmlGlobal = function (t) {
  for (
    var e = this,
      i = 0,
      a = [],
      n = document.querySelectorAll(".ladi-section[data-global-id]"),
      o = 0;
    o < n.length;
    o++
  ) {
    ...
    isEmptyLadiPage(l) || a.push({ id: r.id, data_global_id: l });
  }
  var d = function (n) {
      isObjectLadiPage(n) &&
      ...
      i == a.length &&
        (s(), c(), u(), (e.runtime.isLoadHtmlGlobal = !0), e.run(t));
    },
    s = function () {
      e.runtime.shopping ||
        (0 !=
  ...
  a.forEach(function (t) {
    var a = t.id,
      ...
      o = e.const.API_SECTION_GLOBAL_HTML.format(
        e.runtime.store_id,
        t.data_global_id
      );
      ...
      if (l.readyState == XMLHttpRequest.DONE) {
        ...
        !(function (t) {
          ...
          if (isEmptyLadiPage(a)) d();
            ...
            var n = null;
            try {
              (n = JSON.parse(a.innerHTML)),
                (n = e.deOptimizeEventData(
                  e.copy(n),
                  e.const.OPTIMIZE_EVENT_DATA_KEY_LIST,
                  "OPTIMIZE_EVENT_DATA_KEY_LIST"
                )),
                (n = e.decodeValue(n));
            } catch (t) {}
      ...
      if (!isEmptyLadiPage(i) && i.id != r.runtime.builder_section_popup_id) {
        ...
        if (
          ...
          var L =
            ...
            u);
          this.updateHeightElement(!1, i, L, v, P, o);
        }
      }
      if (t) {
        if (this.runtime.tmp.is_loaded_func_done) {
          var h = document.getElementById(l);
          isEmptyLadiPage(h) || h.parentElement.removeChild(h);
        }
      ...
      if (e == c.const.VIDEO_TYPE.direct) {
        ...
        m.removeAttribute("src"),
          ...
          m.addEventListener("playing", function (t) {
            if (n) {
              var e = function () {
                m.currentTime >= 0.1 ? L() : c.runTimeout(e, 100);
              };
              e();
            }
            p(m, !0);
  ...
  (LadiPageScriptV2.prototype.runResizeAll = function () {
    var t = this;
    t instanceof LadiPageScriptV2 || (t = LadiPageScript),
      t.removeTimeout(t.runtime.tmp.timeout_is_resize_all_id),
      (t.runtime.tmp.is_window_resize = !0);
    try {
      ...
      for (
        ...
        "none" != getComputedStyle(e[i]).display &&
          ((t.runtime.tmp.is_resize_all = !0),
          window.ladi(e[i].id).show(!0, { checkHidePopupOther: !1 }));
      t.runResizeSectionBackground();
    } catch (t) {}
    t.runtime.tmp.timeout_is_resize_all_id = t.runTimeout(function () {
      delete t.runtime.tmp.is_resize_all, delete t.runtime.tmp.is_window_resize;
    }, 200);
  }),
      ...
      try {
        (c = document.querySelector(o)),
          isEmptyLadiPage(c) ||
            ...
            (window.ladi(c.id).scroll(!1, !0), (o = null));
      } catch (t) {}
    if (
      (a.forEach(function (t) {
        window.ladi(t).hide();
    ...
    LadiPageQueueCommand.push(
      ...
      function () {
        if (
          ...
          for (
            var n = 0;
            n < window.ladi_conversion_api.facebook.events.length;
            n++
          ) {
            var o = window.ladi_conversion_api.facebook.events[n].data;
            (o.event_id = o.eventID),
              delete o.eventID,
              (window.ladi_conversion_api.facebook.events[n].data = o);
          }
          a.runtime.tmp.runTrackingAnalytics("ConversionApi", {
  ...
  (LadiPageScriptV2.prototype.getLinkUTMRedirect = function (t, e) {
    ...
    if (!isEmptyLadiPage(i.href) && !isEmptyLadiPage(i.host)) {
      ...
      isArrayLadiPage(window.LadiPageURLSearchParamsCustom) &&
        (o = window.LadiPageURLSearchParamsCustom),
  ...
  (LadiPageScriptV2.prototype.sendRequestWithOption = function (
    ...
    if (
      isFunctionLadiPage(this.runtime.send_request_response[e]) &&
    ...
    if (isObjectLadiPage(l)) {
      ...
      if (
        ...
        if (isStringLadiPage(l.product.variants[0].option_ids)) {
          for (
            h = l.product.variants[0].option_ids.split("/"), u = 0;
            u < h.length;
            u++
          )
            if (h[u] == v) {
          ...
          if (!isEmptyLadiPage(L)) {
            ...
            r.classList.contains("ladi-form-label-container") &&
              ...
              l.product.variants.forEach(function (t) {
                if (isEmptyLadiPage(E) || E == t["option" + (L + 1)])
                  for (u = 0; u < h.length; u++)
                    isArrayLadiPage(P[h[u]]) || (P[h[u]] = []),
                      u != L && P[h[u]].push(t["option" + (u + 1)]);
              });
          }
        }
        for (var A = P, b = [], T = [], w = null, S = 0; S < y.length; S++) {
            ...
            if (
              ...
              if (
                ...
                for (C = 0; C < w.length; C++)
                  if ((k = w[C].getAttribute("data-product-option-id")) != v)
                    for (
                      (isArrayLadiPage(P[k]) &&
                        -1 != P[k].indexOf(w[C].value)) ||
                        (w[C].value = ""),
                        x = w[C].getElementsByTagName("option"),
                        I = 0;
                      I < x.length;
                      I++
                    )
                      isEmptyLadiPage(x[I].getAttribute("value")) ||
                        x[I].removeAttribute("disabled");
                for (C = 0; C < w.length; C++) {
                  for (
                    k = w[C].getAttribute("data-product-option-id"),
                      P = {},
                      N = 0;
                    ...
                    if (
                      ...
                      (h = B.option_ids.split("/")),
                      -1 != (L = h.indexOf(k)) &&
                        (isEmptyLadiPage(w[C].value) ||
                          w[C].value == B["option" + (L + 1)]))
                    )
                      for (u = 0; u < h.length; u++)
                        isArrayLadiPage(P[h[u]]) || (P[h[u]] = []),
                          u != L && P[h[u]].push(B["option" + (u + 1)]);
                  for (D = 0; D < w.length; D++)
                    if ((R = w[D].getAttribute("data-product-option-id")) != k)
                      for (
                        x = w[D].getElementsByTagName("option"), I = 0;
                        I < x.length;
                        I++
                      )
                        isEmptyLadiPage(x[I].getAttribute("value")) ||
                          (isArrayLadiPage(P[R]) &&
                            -1 != P[R].indexOf(x[I].getAttribute("value"))) ||
              ...
              if (
                ...
                for (C = 0; C < w.length; C++)
                  if ((k = w[C].getAttribute("data-product-option-id")) != v) {
                    ...
                    for (
                      (isArrayLadiPage(P[k]) && -1 != P[k].indexOf(F)) ||
                        o.runtime.tmp.updateLabelValue(w[C], null),
                        x = w[C].getElementsByClassName("ladi-form-label-item"),
                        I = 0;
                      I < x.length;
                      I++
                    )
                      x[I].classList.contains("no-value") ||
                ...
                for (C = 0; C < w.length; C++) {
                  for (
                    ...
                    if (
                      ...
                      if (isEmptyLadiPage(M) || M == B["option" + (L + 1)])
                        for (u = 0; u < h.length; u++)
                          isArrayLadiPage(P[h[u]]) || (P[h[u]] = []),
                            u != L && P[h[u]].push(B["option" + (u + 1)]);
                    }
                  for (D = 0; D < w.length; D++)
                    if ((R = w[D].getAttribute("data-product-option-id")) != k)
                      for (
                        x = w[D].getElementsByClassName("ladi-form-label-item"),
                          I = 0;
                        I < x.length;
                        I++
                      )
                        if (!x[I].classList.contains("no-value")) {
                          var Y = o.runtime.tmp.getOptionLabelValue(x[I]);
                          (isArrayLadiPage(P[R]) && -1 != P[R].indexOf(Y)) ||
    ...
    if (
      ...
      if (!isEmptyLadiPage(_)) {
        if (
          ...
          (_ = parseInt(_) || _),
          (L = c.runtime.tmp.product_info[m][_]),
          (h = function () {
            return u(L);
          }),
          isNullLadiPage(L))
          ...
          var E = function () {
            ...
            A = function (t) {
              if (
                ((L = isObjectLadiPage(c.runtime.tmp.product_info[m][_])
                  ? c.runtime.tmp.product_info[m][_]
                  : t.data),
                isObjectLadiPage(L))
              ) {
                if (!isObjectLadiPage(L.store_info)) {
                ...
                if (
                  (m != c.const.FORM_CONFIG_TYPE.ladisales &&
                    (L.store_info.id = -1),
                  isObjectLadiPage(L.store_info.currency) &&
                    !isEmptyLadiPage(L.store_info.currency.code) &&
                    (L.store_info.currency.symbol = c.formatCurrency(
                      null,
                      L.store_info.currency.code,
                      !1,
                      !0
                    )),
                  isObjectLadiPage(L.product) &&
                    isArrayLadiPage(L.product.options) &&
                    isArrayLadiPage(L.product.variants))
                ) {
                  var i = L.product.options.map(function (t) {
                    return t.product_option_id;
                  });
                  if (
                    ((i = i.join("/")),
                    -1 != [c.const.FORM_CONFIG_TYPE.ladisales].indexOf(m) &&
                      1 == L.product.options.length &&
                      isObjectLadiPage(L.product.options[0]) &&
                      isArrayLadiPage(L.product.options[0].values) &&
                      L.product.variants.length ==
                        L.product.options[0].values.length &&
                      (L.product.type == c.const.PRODUCT_TYPE.event ||
                        L.product.type == c.const.PRODUCT_TYPE.service))
                  ) {
                    for (var a = [], n = 0; n < L.product.variants.length; n++)
                      for (
                        var o = 0;
                        o < L.product.options[0].values.length;
                        o++
                      )
                        if (
                          isObjectLadiPage(L.product.options[0].values[o]) &&
                          L.product.options[0].values[o].name ==
                            L.product.variants[n].option1
                        ) {
                          a.push(L.product.options[0].values[o]);
                          break;
                        }
                    L.product.options[0].values = a;
                  }
                  for (var r = 0; r < L.product.variants.length; r++)
                    -1 != [c.const.FORM_CONFIG_TYPE.ladisales].indexOf(m) &&
                      1 == L.product.variants[r].allow_sold_out &&
                      (L.product.variants[r].inventory_checked = 0),
                      isNullLadiPage(L.product.variants[r].compare_price) &&
                        (L.product.variants[r].compare_price =
                          L.product.variants[r].price_compare),
                      isNullLadiPage(
                        L.product.variants[r].variant_start_date
                      ) &&
                        (L.product.variants[r].variant_start_date =
                          L.product.variants[r].start_date),
                      isNullLadiPage(L.product.variants[r].variant_end_date) &&
                        (L.product.variants[r].variant_end_date =
                          L.product.variants[r].end_date),
                      isNullLadiPage(L.product.variants[r].variant_timezone) &&
                        (L.product.variants[r].variant_timezone =
                          L.product.variants[r].timezone),
                      isEmptyLadiPage(L.product.variants[r].option_ids) &&
                        (L.product.variants[r].option_ids = i),
                      -1 !=
                        [
                          c.const.FORM_CONFIG_TYPE.sapo,
                          c.const.FORM_CONFIG_TYPE.haravan,
                        ...
                        1 == L.product.variants.length &&
                        "Default Title" == L.product.variants[r].title &&
                        ((L.product.variants[r].title = null),
                        (L.product.variants[r].option1 = null),
                        (L.product.options = [])),
                      -1 != [c.const.FORM_CONFIG_TYPE.wordpress].indexOf(m) &&
                        1 == L.product.variants.length &&
                        L.product.variants[r].title ==
                          L.product.variants[r].product_name &&
                        ((L.product.variants[r].title = null),
                        (L.product.variants[r].option1 = null),
                        (L.product.options = [])),
                      isEmptyLadiPage(L.product.variants[r].package_quantity) ||
                        isEmptyLadiPage(
                          L.product.variants[r].package_quantity_unit
                        ) ||
                        (isNullLadiPage(L.product.variants[r].title_old) &&
                          (L.product.variants[r].title_old =
                            L.product.variants[r].title),
                        (L.product.variants[r].title =
                          L.product.variants[r].title_old +
                          " (" +
                          L.product.variants[r].package_quantity +
                          " " +
                          L.product.variants[r].package_quantity_unit +
                          ")"));
                  if (
                    ...
                    for (
                      var l = null,
                        ...
                        p = 0;
                      p < L.product.options[0].values.length;
                      p++
                    ) {
                      l = L.product.options[0].values[p].name;
                      var g = L.product.variants.find(u);
                      (L.product.options[0].values[p].name_new =
                        L.product.options[0].values[p].label ||
                        L.product.options[0].values[p].name),
                        isEmptyLadiPage(g) ||
                ...
                (c.runtime.tmp.product_info[m][_] = L),
                  (s = h()),
              ...
              if (c.runtime.isClient) {
                ...
                m == c.const.FORM_CONFIG_TYPE.ladisales
                  ...
                  : ((T = { "Content-Type": "application/json" }),
                    ...
                    (b = { form_account_id: p, product_id: _ }),
                    (b = JSON.stringify(b))),
                  c.sendRequest(w, t, b, !0, T, function (t, e, i) {
        ...
        !0 === L
          ...
          : ((s = h()), !l && isFunctionLadiPage(d) && d(s));
      }
      ...
      if (
        ...
        (L = c.runtime.tmp.product_info[m][_]),
        (h = function () {
          return e ? "" : isObjectLadiPage(L) ? L : null;
        }),
        isNullLadiPage(L))
      )
        return (
      ...
      var u = this.runtime.isDesktop ? this.const.DESKTOP : this.const.MOBILE,
        ...
        _ = function (t, e, i, a, n, r) {
          if (
            ...
            var l = o.generateVariantProduct(
                i,
                !0,
                ...
                o.updateProductVariantSelectOption(e, i, a, !1, function () {
                  ...
                  if (!isEmptyLadiPage(l)) {
                    ...
                    if (!isEmptyLadiPage(d))
                      for (
                        var s = d.querySelectorAll('[data-variant="true"]'),
                          c = 0;
                        c < s.length;
                        c++
                      )
                        if (s[c].id != l.id) {
                          ...
                          if (
                            ...
                            ((m = n.variants[a]),
                            isObjectLadiPage(m) &&
                              isStringLadiPage(m.option_ids))
                          )
                            for (
                              g = m.option_ids.split("/"), _ = 0;
                              _ < g.length;
                              _++
                            )
                              (p = s[c].querySelector(
                                'select[data-product-option-id="' + g[_] + '"]'
                              )),
                                isEmptyLadiPage(p) ||
                                  (p.value = m["option" + (_ + 1)]);
                          if (
                            u["option.product_variant_type"] ==
                              o.const.PRODUCT_VARIANT_TYPE.label &&
                            ((m = n.variants[a]),
            ...
            o.showParentVisibility(e, function () {
              for (
                var t = e.clientHeight,
                  n = t,
                  r = e.querySelectorAll("select.ladi-form-control"),
                  m = {},
                  g = 0;
                g < r.length;
                g++
                ...
                m[
                  r[g].getAttribute("data-store-id") +
                    "_" +
                    r[g].getAttribute("data-product-id") +
                    "_" +
                    r[g].getAttribute("data-product-option-id")
                ] = r[g].value;
              ...
              for (
                ...
                y[P].removeEventListener("change", d),
                  y[P].addEventListener("change", d),
                  (f =
                    m[
                      y[P].getAttribute("data-store-id") +
                        "_" +
                        y[P].getAttribute("data-product-id") +
                        "_" +
                        y[P].getAttribute("data-product-option-id")
                    ]),
                  isNullLadiPage(f) &&
                    ((v = y[P].querySelector("option")),
                    isEmptyLadiPage(v) || (f = v.getAttribute("value"))),
                  (y[P].value = f);
              var L = e.querySelectorAll(".ladi-form-label-container");
              for (P = 0; P < L.length; P++) {
                for (
                  var h = L[P].querySelectorAll(".ladi-form-label-item"), E = 0;
                  E < h.length;
                  E++
                )
                  o.tapEventListener(h[E], p);
                (f =
                  m[
                    L[P].getAttribute("data-store-id") +
                      "_" +
                      L[P].getAttribute("data-product-id") +
                      "_" +
                      L[P].getAttribute("data-product-option-id")
                  ]),
                  isNullLadiPage(f) &&
                    ((v = h[1]), isEmptyLadiPage(v) || (f = s(v))),
                  c(L[P], f);
              }
              if (
                ...
                isEmptyLadiPage(A) ||
                  ((A = o.findAncestor(A, "ladi-element")),
                  o.updateHeightElement(!0, e, A, t, n));
              }
            });
          }
              ...
              g = function (t) {
                if (!isEmptyLadiPage(t.target.value)) {
                  ...
                  if (
                    ...
                    var a = t.target;
                    a = (a = o.findAncestor(a, "ladi-form")).querySelector(
                      '[data-variant="true"]'
                    );
        ...
        y = function (t, e, i, a, n, r) {
          ...
          if (
            (l &&
              ...
              isEmptyLadiPage(m) || (m.innerHTML = isNullLadiPage(s) ? "" : s)),
            l &&
              "paragraph" == u &&
            ...
            isEmptyLadiPage(g) ||
              (isEmptyLadiPage(p)
                ...
                : g.style.setProperty("background-image", 'url("' + p + '")'));
          }
          if ("gallery" == u) {
            if (l && !isArrayLadiPage(s)) return;
            if (r && !n && "true" == t.getAttribute("data-collection"))
              return void o.runtime.tmp.updateImageGalleryProduct(t, c, e);
            ...
            if ((isEmptyLadiPage(P) || P.style.removeProperty("left"), l)) {
              for (
                var L = t.getElementsByClassName("ladi-gallery-view-item");
                L.length < s.length;

              ) {
                var h = o.createTmpElement(
                  "div",
                ...
                t.getElementsByClassName("ladi-gallery-view")[0].appendChild(h);
              }
            ...
            o.runtime.tmp.runGallery(t.id, t, !0, u),
        ...
        f = function (t, e) {
          ...
          if (isObjectLadiPage(u) && isArrayLadiPage(u.products)) {
            ...
            if (!isEmptyLadiPage(u.total_record) && i * c >= u.total_record) {
              ...
              v.setAttribute("data-max-page", P),
                (L = !0),
                i * c > u.total_record && (h = !0);
            }
            ...
            var A = v.getElementsByClassName("ladi-collection-arrow-left")[0],
              ...
              T = v.getElementsByClassName("ladi-collection-button-next")[0];
            if (
              (isEmptyLadiPage(A) || A.classList.remove("opacity-0"),
              isEmptyLadiPage(b) || b.classList.remove("opacity-0"),
              isEmptyLadiPage(T) || T.classList.remove("opacity-0"),
              1 == v.getAttribute("data-page") &&
                s == o.const.COLLECTION_TYPE.carousel &&
                (isEmptyLadiPage(A) || A.classList.add("opacity-0")),
              v.getAttribute("data-page") == v.getAttribute("data-max-page") &&
                (s == o.const.COLLECTION_TYPE.readmore &&
                  (isEmptyLadiPage(T) || T.classList.add("opacity-0")),
                s == o.const.COLLECTION_TYPE.carousel &&
                  (isEmptyLadiPage(b) || b.classList.add("opacity-0"))),
              P < i)
            )
              return;
            var w = v.getElementsByClassName("ladi-collection-item");
            if (0 == w.length) return;
            var S = 0,
              O = 0;
            if (v.hasAttribute("data-max-option-length"))
              S = parseFloatLadiPage(v.getAttribute("data-max-option-length"));
            else {
            ...
            var N = v.getElementsByClassName("ladi-collection-content")[0],
              D = { className: w[0].className, innerHTML: w[0].innerHTML };
            a && w[0].parentElement.removeChild(w[0]);
            for (
              var k = N.getElementsByClassName("ladi-collection-page");
              k.length < i;

            ) {
              var x = document.createElement("div");
              (x.className = "ladi-collection-page"), N.appendChild(x);
            }
            var R = k[i - 1],
            ...
            var F = function (t, i, a, n, s, c) {
              ...
              for (var u = 0; u < t.length; u++) {
                a &&
                  isFunctionLadiPage(o.runtime.tmp.runElementClickSelected) &&
                  o.runtime.tmp.runElementClickSelected(t[u], !0);
                var p = o.copy(o.runtime.eventData[t[u].id]);
                isEmptyLadiPage(p) ||
                  (o.runAnimationDoc(t[u], p, { element_type: p.type }),
                  (p["option.product_type"] = r),
                  (p["option.ladisale_store_id"] = l),
                  (p["option.product_tag_id"] = d),
                  (p["option.product_id"] = i.id),
                  a &&
                    (isFunctionLadiPage(o.runtime.tmp.runOptionAction) &&
                      o.runtime.tmp.runOptionAction(t[u], t[u].id, p.type, p),
                    isFunctionLadiPage(o.runtime.tmp.runOptionHover) &&
                      o.runtime.tmp.runOptionHover(
                        t[u],
                        t[u].id,
                        p.type,
                        p["option.data_event"] || p["option.data_hover"]
                      ),
                    _(t, t[u], e, p, i, F)),
                  y(t[u], p, n, s, a, c));
              }
            };
            for (O = 0; O < u.products.length; O++)
              isArrayLadiPage(u.products[O].options) &&
                u.products[O].options.length > S &&
                (S = u.products[O].options.length);
            for (
              v.setAttribute("data-max-option-length", S), O = 0;
              O < u.products.length;
              O++
            )
              if (!(B.length > O)) {
                ...
                for (
                  var Y = M.getElementsByClassName("ladi-element");
                  isArrayLadiPage(u.products[O].options) &&
                  u.products[O].options.length < S;

                )
                  u.products[O].options.push({ is_tmp: !0 });
                F(Y, u.products[O], !0, null, !1, !1);
              }
            L && (R.classList.add("last"), h && R.classList.add("not-full")),
              s == o.const.COLLECTION_TYPE.carousel &&
                (function (t) {
                  var e = document.getElementById(t);
                  ...
                  if (!isEmptyLadiPage(e)) {
                    ...
                    if (e.hasAttribute("data-max-page")) {
                      ...
                      if (p == r) a.style.removeProperty("height");
                        ...
                        (l -= parseFloatLadiPage((g * (p - r)) / p) || 0),
                    ...
                    if (d != s) {
                      ...
                      isEmptyLadiPage(c) &&
                        (c = o.findAncestor(e.parentElement, "ladi-section")),
                        o.updateHeightElement(!0, e, c, d, s);
                    }
                  }
                })(t),
              o.runEventScroll(),
  ...
  (LadiPageScriptV2.prototype.getListProductByTagId = function (t, e, i, a, n) {
    ...
    if (isArrayLadiPage(s) && s.length > 0) {
      if (
        ...
        var L = null;
        if ((isStringLadiPage(v) && ((L = v), (v = null)), isNullLadiPage(v))) {
                  ...
                  for (
                    ...
                    if (
                      ...
                      for (var P = 0; P < v.products[c].variants.length; P++)
                        -1 != [o.const.FORM_CONFIG_TYPE.ladisales].indexOf(l) &&
                          1 == v.products[c].variants[P].allow_sold_out &&
                          (v.products[c].variants[P].inventory_checked = 0),
                          isNullLadiPage(
                            v.products[c].variants[P].compare_price
                          ) &&
                            (v.products[c].variants[P].compare_price =
                              v.products[c].variants[P].price_compare),
                          isNullLadiPage(
                            v.products[c].variants[P].variant_start_date
                          ) &&
                            (v.products[c].variants[P].variant_start_date =
                              v.products[c].variants[P].start_date),
                          isNullLadiPage(
                            v.products[c].variants[P].variant_end_date
                          ) &&
                            (v.products[c].variants[P].variant_end_date =
                              v.products[c].variants[P].end_date),
                          isNullLadiPage(
                            v.products[c].variants[P].variant_timezone
                          ) &&
                            (v.products[c].variants[P].variant_timezone =
                              v.products[c].variants[P].timezone),
                          isEmptyLadiPage(
                            v.products[c].variants[P].option_ids
                          ) && (v.products[c].variants[P].option_ids = u),
                          -1 !=
                            [
                              o.const.FORM_CONFIG_TYPE.sapo,
                              o.const.FORM_CONFIG_TYPE.haravan,
                            ...
                            ((v.products[c].variants[P].title = null),
                            (v.products[c].variants[P].option1 = null),
                            (v.products[c].options = [])),
                          -1 !=
                            [o.const.FORM_CONFIG_TYPE.wordpress].indexOf(l) &&
                            1 == v.products[c].variants.length &&
                            v.products[c].variants[P].title ==
                              v.products[c].variants[P].product_name &&
                            ((v.products[c].variants[P].title = null),
                            (v.products[c].variants[P].option1 = null),
                            (v.products[c].options = [])),
                          isEmptyLadiPage(
                            v.products[c].variants[P].package_quantity
                          ) ||
                            isEmptyLadiPage(
                              v.products[c].variants[P].package_quantity_unit
                            ) ||
                            (isNullLadiPage(
                              v.products[c].variants[P].title_old
                            ) &&
                              (v.products[c].variants[P].title_old =
                                v.products[c].variants[P].title),
                            (v.products[c].variants[P].title =
                      ...
                      if (
                        ...
                        for (
                          var L = 0;
                          L < v.products[c].options[0].values.length;
                          L++
                        ) {
                          r = v.products[c].options[0].values[L].name;
                          var E = v.products[c].variants.find(d);
                          (v.products[c].options[0].values[L].name_new =
                            v.products[c].options[0].values[L].label ||
                            v.products[c].options[0].values[L].name),
                            isEmptyLadiPage(E) ||
              ...
              if (o.runtime.isClient) {
                ...
                l == o.const.FORM_CONFIG_TYPE.ladisales
                  ...
                  : ((b = { "Content-Type": "application/json" }),
                    ...
                    isEmptyLadiPage(L) ? (A.page = i) : (A.page_info = L),
                    (A = JSON.stringify(A))),
                  o.sendRequest(T, a, A, !0, b, function (t, e, i) {
                    if (i.readyState == XMLHttpRequest.DONE)
                      try {
                        var a = JSON.parse(t);
                        E(a);
    ...
    if (!isEmptyLadiPage(e) && isArrayLadiPage(e["option.data_event"])) {
      ...
      isEmptyLadiPage(i) ||
        this.runtime.tmp.runDataEventNow(i, e["option.data_event"], {
          action_type: this.const.ACTION_TYPE.close_popup,
        });
    }
  }),
        ...
        if (
                  ...
                  if (
                    ("default" == v &&
                      (P >= A - window.scrollY
                        ? ((T = P + "px"),
                          (w = b + "px"),
                          P <= 0 && (C = h.clientHeight),
                          (N = h.clientHeight))
                        : S - L - h.clientHeight <= A - window.scrollY &&
                          ((T = "calc(100% - " + (L + h.clientHeight) + "px)"),
                          (w = b + "px"),
                          L <= 0 && (I = h.clientHeight),
                          (D = h.clientHeight))),
                    "top" == v &&
                      (P >= A - window.scrollY || S - 0 < A - window.scrollY) &&
                      ((T = P + "px"),
                      (w = b + "px"),
                      P <= 0 && (C = h.clientHeight),
                      (N = h.clientHeight)),
                    "bottom" == v &&
                      (S - L - h.clientHeight <= A - window.scrollY ||
                        0 > A + h.clientHeight - window.scrollY) &&
                      ((T = "calc(100% - " + (L + h.clientHeight) + "px)"),
                      (w = b + "px"),
                      L <= 0 && (I = h.clientHeight),
                      (D = h.clientHeight)),
                    ...
                    ("section" == i.type &&
                      (e.runtime.is_mobile_only
                        ? h.style.setProperty("width", O.clientWidth + "px")
                        : e.runtime.isDesktop &&
                      ...
                      D > 0 && O.setAttribute("data-scroll-padding-bottom", D)),
                    h.style.setProperty("top", T),
                    h.style.setProperty("left", w),
                    ...
                    h.setAttribute("data-sticky", !0),
                      h.classList.contains("ladi-animation-hidden") &&
                        (h.classList.remove("ladi-animation-hidden"),
                        h.classList.add("ladi-animation"));
                    for (
                      var k = h.getElementsByClassName("ladi-animation-hidden");
                      k.length > 0;

                    )
                      k[0].classList.add("ladi-animation"),
                        k[0].classList.remove("ladi-animation-hidden");
                    h.classList.remove("ladi-lazyload");
                    for (
                      var x = h.getElementsByClassName("ladi-lazyload");
                      x.length > 0;

                    )
                      x[0].classList.remove("ladi-lazyload");
                  }
                }
              }
            }
          ...
          for (
            var s = Math.round(
              ...
              m = 1;
            m < e.const.PERCENT_TRACKING_SCROLL.length;
            m++
          ) {
  ...
  (LadiPageScriptV2.prototype.runShowPopup = function (t, e, i, a, n) {
    var o = this;
    if (!isEmptyLadiPage(e) && !o.runtime.tmp["popup_closing_" + e]) {
      var r = document.getElementById(e);
      if (
        !n ||
        (!isEmptyLadiPage(r) &&
          isObjectLadiPage(o.runtime.eventData) &&
          !isEmptyLadiPage(o.runtime.eventData[e]))
      ) {
        n &&
          ((i =
        ...
        var l = function (t) {
            ...
            isEmptyLadiPage(a)
              ...
              : ((s +=
                  ...
                  a +
                  "}"),
                r.setAttribute("data-popup-backdrop", !0)),
              i == o.const.POSITION_TYPE.default &&
                ...
                (!(function () {
                  if (!o.runtime.has_popupx && n) {
                    ...
                    "block" != r.style.getPropertyValue("display") ||
                      isEmptyLadiPage(o.runtime.tmp.bodyScrollY) ||
                      (t = o.runtime.tmp.bodyScrollY),
                      (s += "body {"),
                      0 ==
                        ...
                        ).length && (s += "position: fixed !important;"),
                      (s += "width: 100% !important;"),
                      (s += "top: -" + t + "px !important;"),
                      (s += "}"),
                  ...
                  for (
                    ...
                    a[l].id != e &&
                      a[l].style.setProperty("z-index", "1", "important");
                  d = 500;
                })(),
            ...
            o.removeTimeout(f),
              (f =
                parseFloatLadiPage(r.getAttribute("data-timeout-id-2")) ||
                null),
              o.removeTimeout(f),
              !n ||
                "true" == r.getAttribute("data-dropbox") ||
                ...
                (isEmptyLadiPage(r.style.getPropertyValue("max-height")) &&
                  r.style.setProperty("visibility", "hidden"));
            r.classList.add("ladi-animation-hidden"),
              "block" != getComputedStyle(r).display &&
                r.style.setProperty("display", "block", "important"),
              (f = o.runTimeout(function () {
                r.classList.remove("ladi-animation-hidden"),
                  r.removeAttribute("data-timeout-id"),
                  (function () {
                    for (
                    ...
                    isObjectLadiPage(o.runtime.tmp.list_timeout_popup_id) ||
                      (o.runtime.tmp.list_timeout_popup_id = {}),
                      isArrayLadiPage(o.runtime.tmp.list_timeout_popup_id[e]) ||
                        (o.runtime.tmp.list_timeout_popup_id[e] = []),
                      o.runtime.tmp.list_timeout_popup_id[e].forEach(function (
                        t
                      ) {
                        o.removeTimeout(t);
                      }),
                  ...
                  (f = o.runTimeout(function () {
                    !(function () {
                      for (
                        var t = function (t) {
                            var i = o.findAncestor(t, "ladi-element"),
                              a = 0;
                            if (!isEmptyLadiPage(i)) {
                              var n = o.runtime.eventData[i.id];
                              isEmptyLadiPage(n) ||
                                (a =
                                  parseFloatLadiPage(
                                    n[
                            ...
                            t.classList.add("ladi-animation");
                            var r = o.runTimeout(function () {
                              t.classList.remove("ladi-animation-hidden");
                            }, 1e3 * a);
                            o.runtime.tmp.list_timeout_popup_id[e].push(r);
                          },
                          i = (function () {
                            for (
                              var t = [],
              ...
              t &&
                ...
                o.runtime.has_popupx &&
                  (m
                    ? (r.setAttribute("data-fixed-close", !0),
              ...
              isEmptyLadiPage(s) ||
                o.runtime.tmp.is_resize_all ||
                o.runtime.tmp.is_wait_popup ||
                o.createStyleElement("style_popup", s);
            var v = null;
            if (
              n &&
              !isEmptyLadiPage(r) &&
              ...
              isEmptyLadiPage(P) &&
                ...
                P.addEventListener("click", function (t) {
                  t.stopPropagation(),
                    (o.runtime.tmp["popup_closing_" + e] = !0),
                    o.runRemovePopup(e, n),
                    o.runTimeout(function () {
                      delete o.runtime.tmp["popup_closing_" + e];
                    }, 500);
                })),
                (f =
                  ...
                  null),
                o.removeTimeout(f),
                "true" == r.getAttribute("data-scroll") &&
              ...
              var L = function () {
                if (
                  ((P = r.getElementsByClassName("popup-close")[0]),
                  !isEmptyLadiPage(P))
                )
                  if ("true" == r.getAttribute("data-scroll")) {
                    ...
                    (u || m) && (i += o.runtime.widthScrollBar),
              ...
              L(),
                ...
                (u || m) &&
                  (r.hasAttribute("data-resize-scroll") ||
                    (r.setAttribute("data-resize-scroll", !0),
                    window.addEventListener("resize", L)));
            }
            n &&
              !c &&
              (o.runEventTracking(e, { is_form: !1 }), o.runActionPopupShow(e));
            var h = function () {
              var t = d;
              (f = o.runTimeout(function () {
                delete o.runtime.tmp.is_run_show_popup,
                  o.runEventScroll(),
                  isFunctionLadiPage(v) && v(),
                  r.removeAttribute("data-timeout-id-2");
              }, t)),
            ...
            if (t) h();
              ...
              (f = o.runTimeout(function () {
                "none" == getComputedStyle(r).display
                  ? ((d -= 100), h())
                  : l(!0),
                  r.removeAttribute("data-timeout-id-2");
              }, 100)),
          ...
          d = 0;
        i == o.const.POSITION_TYPE.default && (d = 100);
        var s = o.runTimeout(function () {
          l(t);
        }, d);
        isEmptyLadiPage(r) || r.setAttribute("data-timeout-id-3", s);
      }
    }
  }),
  ...
  (LadiPageScriptV2.prototype.generateTrackingJS = function (t) {
    var e = "",
      i = "",
      a = [];
    if (
      ...
      (a = t.facebook_pixel.split(",").removeSpace()).length > 0
    ) {
      e +=
      ...
      a.forEach(function (t) {
        var i = t.split("|API");
        (e += 'fbq("init", "' + i[0].trim() + '");'),
          2 == i.length && n.push(i[0].trim());
      }),
        n.length > 0
          ? ((e += "(function () {"),
            (e +=
              'var getEventData = function () {var min = 10000000000; var max = 99999999999; return {eventID: "ladi." + Date.now() + "." + (Math.floor(Math.random() * (max - min + 1)) + min)};};'),
            (e += "var eventDataPageView = getEventData();"),
            (e += 'fbq("track", "PageView", null, eventDataPageView);'),
            t.is_view_content &&
              ((e += "var eventDataViewContent = getEventData();"),
              (e +=
                'fbq("track", "ViewContent", null, eventDataViewContent);')),
            (e +=
              "window.ladi_conversion_api = window.ladi_conversion_api || {facebook: {pixels: []}};"),
            n.forEach(function (t) {
              e +=
                "window.ladi_conversion_api.facebook.pixels.push('" + t + "');";
            }),
            (e +=
              "window.ladi_conversion_api.facebook.events = [{key: 'track', name: 'PageView', data: eventDataPageView}"),
            t.is_view_content &&
              (e +=
                ", {key: 'track', name: 'ViewContent', data: eventDataViewContent}"),
            (e += "];"),
            (e +=
              'if (typeof window.LadiPageScript != "undefined" && window.LadiPageScript != undefined) {window.LadiPageScript.runConversionApi();}'),
            (e += "})();"))
          : ((e += 'fbq("track", "PageView");'),
            t.is_view_content && (e += 'fbq("track", "ViewContent");')),
        (e += "</script>"),
        a.forEach(function (t) {
          var i = t.split("|API");
          e +=
    ...
    null != t.google_ads_id &&
      ...
      (r = t.google_ads_id.split(",").removeSpace()),
      null != t.google_analytics_id &&
        void 0 != t.google_analytics_id &&
        t.google_analytics_id.length > 0 &&
        (o = t.google_analytics_id.split(",").removeSpace()),
      (o.length > 0 || r.length > 0) &&
        ((e +=
          '<script async src="https://www.googletagmanager.com/gtag/js?id=' +
          (o.length > 0 ? o[0] : r[0]) +
          '"></script>'),
        (e += "<script>window.dataLayer = window.dataLayer || [];"),
        (e +=
    ...
    null != t.tiktok_pixel &&
      ...
      t.is_view_content &&
        ((e += "window.LadiPageCommand = window.LadiPageCommand || [];"),
        (e +=
          'window.LadiPageCommand.push({tiktokViewContent: true, name: "ViewContent", clickButton: true, scrollPercent: 50});')),
      (e += 'ttq.page();}(window, document, "ttq");</script>'));
    var d = [];
    return (
      null != t.google_tag_manager_id &&
        void 0 != t.google_tag_manager_id &&
        t.google_tag_manager_id.length > 0 &&
        ((d = t.google_tag_manager_id.split(",").removeSpace()).length > 0 &&
          ((e +=
          ...
          d.forEach(function (t) {
            e += "gtm(window,document,'script','dataLayer','" + t + "');";
          }),
          (e += "</script>")),
        d.forEach(function (t) {
          i +=
    ...
    if (this.runtime.isClient) {
      ...
      var f = function (t) {
        ...
        P = function (t) {
          ...
          if (
            (isObjectLadiPage(i) &&
              ((e = { phone_number: o.convertPhoneNumberFormData(i.phone) }),
              isEmptyLadiPage(i.email) || (e.email = i.email)),
            isObjectLadiPage(e) &&
              !isEmptyLadiPage(e.phone_number) &&
              (t
                ? o.runtime.tmp.runActionPopupX({
                    ttq_identify_data: e,
      ...
      if (!isEmptyLadiPage(a)) {
        var L = !1;
        return (
          isEmptyLadiPage(l) || isEmptyLadiPage(d) || (L = !0),
          isEmptyLadiPage(r) || (L = !0),
          isEmptyLadiPage(s) || (L = !0),
          _ && (L = !0),
          -1 != ["section", "popup", "countdown"].indexOf(m) && (L = !1),
          void (
            L &&
      ...
      f(), v(), P(), isEmptyLadiPage(s) || o.runFunctionString(s);
    }
  }),
      ...
      isObjectLadiPage(r) && r.return_list_match
        ...
        : (l.highlightText(i, m, !0, function (t) {
          ...
          l.runtime.isDesktop &&
            e &&
            !isEmptyLadiPage(c) &&
            ["fb://profile/", "fb://page/?id=", "fb://page/"].forEach(function (
              t
            ) {
              c.startsWith(t) &&
    ...
    if (!isEmptyLadiPage(o)) {
      ...
      for (
        ...
        if (((v = isEmptyLadiPage(v) ? v : v.trim()), t)) {
          ...
          (y = !0) && -1 == n.indexOf(P) && (y = !1),
            y &&
              "country" == P &&
              "true" == p[m].getAttribute("data-is-select-country") &&
              (y = !1),
            y && (g = this.getDataReplaceStr(P, i));
        }
        if (!y) {
          if (
            ...
            continue;
          var L = this.runtime.eventData[f.id];
          if (isEmptyLadiPage(L)) continue;
          var h = L["option.input_default_value"];
          if (isEmptyLadiPage(h)) continue;
          var E = !1;
          "INPUT" == p[m].tagName && "checkbox" == v && (E = !0),
            (g = this.convertDataReplaceStr(h, !1, null, !1, i, E));
        }
        if (!isNullLadiPage(g)) {
          if (
      ...
      for (
        ...
        var D = I[N].getAttribute(
          "data-replace-" + this.runtime.device + "-src"
        );
        (D = this.convertDataReplaceStr(D, !0, null, !1, i)),
          (D = decodeURIComponentLadiPage(D));
        this.findAncestor(I[N], "ladi-element");
        if (isEmptyLadiPage(D))
          I[N].style.setProperty("background-image", "none");
        else {
          var k = this.findAncestor(I[N], "ladi-element");
          (D = this.getOptimizeImage(
            D,
            k.clientWidth,
            k.clientHeight,
            !0,
            ...
            I[N].style.setProperty("background-image", 'url("' + D + '")');
        }
      }
      this.runFormulaData();
    }
  ...
  (LadiPageScriptV2.prototype.showMessage = function (t, e, i) {
    if (
      ...
      this.runtime.has_popupx)
    )
      (this.runtime.tmp.popupx_show_message_callback = i),
      ...
      if (
        ...
        return void (isFunctionLadiPage(i) && i());
  ...
  (LadiPageScriptV2.prototype.run = function (t) {
    ...
    if (e.runtime.isLoadHtmlGlobal) {
      e.runTimeout(function () {
        e.runtime.formdata &&
          isNullLadiPage(e.runFormData) &&
          e.loadScript(
            e.const.CDN_LIBRARY_JS_URL +
          ...
          e.trackingInit(e.runtime.data_delay_js),
          e.customScriptDelayInit();
      }, e.runtime.time_delay_js),
        (e.const.LANG = isObjectLadiPage(e.const["LANG" + e.runtime.lang])
          ? e.const["LANG" + e.runtime.lang]
          : e.const.LANG),
      ...
      (e.runtime.isClient = t),
        ...
        isEmptyLadiPage(e.runtime.timenow)
        ...
        if (!isEmptyLadiPage(o))
          try {
            (e.runtime.eventData = JSON.parse(o.innerHTML)),
              (e.runtime.eventData = e.deOptimizeEventData(
                e.copy(e.runtime.eventData),
                e.const.OPTIMIZE_EVENT_DATA_KEY_LIST,
                "OPTIMIZE_EVENT_DATA_KEY_LIST"
              )),
      ...
      r.forEach(function (t) {
        ...
        (r = Object.keys(e.runtime.eventData)).forEach(function (t) {
          ...
          Object.keys(e.runtime.eventData[t]).forEach(function (n) {
            n.toLowerCase().startsWith(e.const.DEVICE) &&
              ((i = e.const.DESKTOP + n.substring(e.const.DEVICE.length)),
              (a = e.const.MOBILE + n.substring(e.const.DEVICE.length)),
              (e.runtime.eventData[t][i] = e.runtime.eventData[t][n]),
              (e.runtime.eventData[t][a] = e.runtime.eventData[t][n]),
              delete e.runtime.eventData[t][n]),
              e.runtime.isDesktop &&
                n.toLowerCase().startsWith(e.const.DESKTOP) &&
                ((a = e.const.MOBILE + n.substring(e.const.DESKTOP.length)),
                (e.runtime.eventData[t][a] = e.runtime.eventData[t][n])),
              !e.runtime.isDesktop &&
                n.toLowerCase().startsWith(e.const.MOBILE) &&
                ((i = e.const.DESKTOP + n.substring(e.const.MOBILE.length)),
                (e.runtime.eventData[t][i] = e.runtime.eventData[t][n]));
          });
        });
      try {
        var l = window.ladi("LADI_DATA").get_cookie();
        (e.runtime.tmp.cookie_ladi_data = l),
          (l = JSON.parse(Base64.decode(l || Base64.encode("{}")))),
      ...
      u.forEach(function (t) {
        if (t != e.const.TRACKING_NAME && t != e.const.ACCESS_KEY_NAME) {
          if (
            (e.setDataReplaceStr(t, c[t]),
            "products" == t && isStringLadiPage(c[t]))
          ) {
            var i = c[t].split("|");
            2 == i.length &&
      ...
      isEmptyLadiPage(m)
        ? (m = window.ladi("ladi_ref").get_cookie())
        : window.ladi("ladi_ref").set_cookie(m, 90, "/", window.location.host);
      var g = Object.keys(e.runtime.eventData),
        _ = [],
        y = window.ladi("LADI_CLIENT_ID").get_cookie(),
        f = parseFloatLadiPage(window.ladi("LADI_PAGE_VIEW").get_cookie()) || 0,
        v =
        ...
        h = window.ladi("LADI_CAMP_NAME").get_cookie(),
        ...
        S = function (t, i, a) {
          if ("FormSubmit" == t && isEmptyLadiPage(y))
            ...
            Object.keys(i).forEach(function (t) {
              ...
              isEmptyLadiPage(c.element_id))
                ...
                : ("FormSubmit" == t &&
                    (isEmptyLadiPage(L) ? v++ : (A == b && v++, w++),
                    window.ladi("LADI_CAMP_FORM_SUBMIT").set_cookie(w, 3650),
                    window.ladi("LADI_FORM_SUBMIT").set_cookie(v, 3650),
                    e.runtime.is_popupx &&
                  ...
                  "PageView" == t &&
                    ...
                    (f++, window.ladi("LADI_PAGE_VIEW").set_cookie(f, 3650)),
                  ("FormSubmit" != t && "PageView" != t) ||
                    isEmptyLadiPage(e.runtime.tmp.cookie_ladi_data) ||
                    (!e.runtime.is_popupx && isEmptyLadiPage(L)) ||
                    (c.ladi_data = e.runtime.tmp.cookie_ladi_data),
                  e.sendRequest(
                    "POST",
        ...
        O = function (t, i, a, n) {
          ...
          if (isEmptyLadiPage(i) || "POPUP_PRODUCT" != i.id)
            if (isEmptyLadiPage(i) || "POPUP_BLOG" != i.id)
                ...
                if (
                  ...
                  var m = function (t) {
                    (!e.runtime.isDesktop ||
                      (isEmptyLadiPage(t.getAttribute("height")) &&
                        isEmptyLadiPage(t.style.getPropertyValue("height")))) &&
                  ...
                  for (d = 0; d < r.length; d++)
                    e.runtime.tmp.runLadiSaleProductKey(
                      ...
                      isFunctionLadiPage(e.runtime.tmp.runOptionAction) &&
                        isObjectLadiPage(a) &&
            ...
            if (isEmptyLadiPage(a["option.product_variant_id"])) {
              ...
              if (isEmptyLadiPage(c)) {
                for (
                  ...
                  if (
                    isEmptyLadiPage(
                      e.findAncestor(p[m], "ladi-collection-item")
                    )
                  ) {
                    u = p[m];
                    break;
            ...
            for (
              r = document.querySelectorAll("#" + i.id + " .ladi-element"),
                d = 0;
              d < r.length;
              d++
            )
              e.runtime.tmp.runLadiSaleProductKey(r[d].id, !1, !1, l, o),
                _(r[d]);
            isFunctionLadiPage(n) && n();
          }
        },
              ...
              if (i.action_type == a.action_type) {
                ...
                if (
                  ...
                  i.type == e.const.DATA_ACTION_TYPE.change_index &&
                    ((l = window.ladi(i.action)),
                    isFunctionLadiPage(l[i.change_index_type])
                      ? l[i.change_index_type]()
                      : l.index(i.change_index_number || 1)),
                  i.type == e.const.DATA_ACTION_TYPE.set_value &&
                    ((l = window.ladi(i.action)),
                    isEmptyLadiPage(l) ||
                      (i.is_clipboard
                        ? e.getTextClipboard(i.str, function (e, a) {
                            l.value(e ? a : i.str), I(t, e, !0);
                          })
                        : l.value(i.str))),
                  ...
                  var u = i.action;
                  isEmptyLadiPage(u) ||
                    ((u = e.getLinkUTMRedirect(u, null)),
                    (u = e.convertDataReplaceStr(u, !0)),
                    window.ladi(u).open_url(i.target, i.nofollow));
                }
                ...
                if (
                  (i.type == e.const.DATA_ACTION_TYPE.set_style &&
                    ((l = window.ladi(i.action)),
                    isEmptyLadiPage(l) || l.set_style(t, i)),
                  i.type == e.const.DATA_ACTION_TYPE.lightbox)
                ) {
                  if (
                    a.lightbox_type == e.const.DATA_ACTION_LIGHTBOX_TYPE.image
                  ) {
                    var m = i.image_url;
                    isEmptyLadiPage(m) &&
                      (m = i["image_url_" + e.runtime.device]),
                      lightbox_image(m);
                  }
                  a.lightbox_type == e.const.DATA_ACTION_LIGHTBOX_TYPE.video &&
                    lightbox_video(i.video_url, i.video_type, !1),
                    a.lightbox_type ==
                      e.const.DATA_ACTION_LIGHTBOX_TYPE.video &&
                      lightbox_iframe(i.iframe_url);
                }
                if (i.type == e.const.DATA_ACTION_TYPE.tracking) {
                  var g = { is_custom: !0 };
                  (g.conversion_name = i.conversion_name),
                    (g.google_ads_conversion = i.google_ads_conversion),
                    (g.google_ads_label = i.google_ads_label),
                    (g.event_category = ""),
                    (i.action_type != e.const.ACTION_TYPE.open_popup &&
                      i.action_type != e.const.ACTION_TYPE.close_popup) ||
                      (g.event_category = "LadiPagePopup"),
                    e.runEventTracking(null, g),
                    isEmptyLadiPage(i.event_custom_script) ||
                      e.runFunctionString(i.event_custom_script);
                }
                i.type == e.const.DATA_ACTION_TYPE.custom_script &&
                  (isEmptyLadiPage(i.event_custom_script) ||
                    e.runFunctionString(i.event_custom_script));
              }
            });
        ...
        I = function (t, i, a) {
          ...
          e.getElementBoundingClientRect(t).y < 35 && (r = !1),
            ...
            i
              ...
              : t.setAttribute("data-hint", e.const.LANG.FAILED),
          ...
          if (((t = t || document.getElementById(i)), !isEmptyLadiPage(t))) {
            ...
            if (!n["option.action_funnel"] || isEmptyLadiPage(P))
              if (!u || isEmptyLadiPage(p)) {
                ...
                if (
                  !isArrayLadiPage(m) &&
                  ((m = []), isObjectLadiPage(n["option.data_action"]))
                ) {
                ...
                m.forEach(function (a) {
                    ...
                    if (
                      ...
                      a.type == e.const.DATA_ACTION_TYPE.collapse &&
                        t.addEventListener("click", function (e) {
                          d(t, e) &&
                            c(a) &&
                            C(t, [a], { action_type: a.action_type });
                        }),
                      ...
                      isEmptyLadiPage(s) || s.set_style(t, a, !0),
                        t.addEventListener("click", function (e) {
                          d(t, e) &&
                            c(a) &&
                            C(t, [a], { action_type: a.action_type });
                        ...
                        t.addEventListener("click", function (i) {
                          if (d(t, i) && c(a)) {
                            ...
                            isEmptyLadiPage(o) ||
                              ...
                              isEmptyLadiPage(n) || e.copyTextClipboard(n, y);
                          }
                        }),
                      a.type == e.const.DATA_ACTION_TYPE.custom_script &&
                        t.addEventListener("click", function (e) {
                          d(t, e) &&
                            c(a) &&
                            C(t, [a], { action_type: a.action_type });
                  ...
                  e.runEventTracking(
                    i,
                    { count_data_event: v, is_click: !0, is_form: !1 },
                    null,
                    t,
                    d
                  );
              ...
              if (
                ...
                i.type == e.const.DATA_ACTION_TYPE.change_index &&
                  t.addEventListener("mouseenter", function (t) {
                    ...
                    isFunctionLadiPage(e[i.change_index_type])
                      ? e[i.change_index_type]()
                      : e.index(i.change_index_number || 1);
                  }),
                i.type == e.const.DATA_ACTION_TYPE.set_style)
              ) {
        ...
        B = function () {
          g.forEach(function (t) {
            ...
            if (
              !isEmptyLadiPage(i) &&
              "true" != i.getAttribute("data-action")
            ) {
              var a = e.runtime.eventData[t],
          ...
          for (
            ...
            if (isEmptyLadiPage(t[i].getAttribute("href")))
        ...
        M = function () {
          if (t) {
            var i = function () {
              ...
              a = !1,
              n = isArrayLadiPage(e.runtime.DOMAIN_FREE)
        ...
        Y = function (t, i, a, n) {
          if (
            ...
            if (
              isEmptyLadiPage(e.runtime.timeout_gallery[o]) &&
              ...
              if (
                ...
                var g = e.getElementBoundingClientRect(t),
                  _ = e.getElementBoundingClientRect(
          ...
          a || (e.pauseAllVideo(), (e.runtime.tmp.gallery_playing_video = !0)),
            isEmptyLadiPage(d)
              ? (n == e.const.VIDEO_TYPE.youtube &&
                  ...
                  i.parentElement.insertBefore(d, i.nextSibling),
                  (d.outerHTML =
                    '<iframe id="' +
                    l +
                    '" class="iframe-video-preload" data-video-type="' +
                    n +
                    '" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'),
                  e.runEventPlayVideo(l, n, o, !1, !1, !0, a, !1, !0)),
        ...
        q = function (t, i, a, n) {
          if (
            "gallery" == n &&
            (a || (i = document.getElementById(t)), !isEmptyLadiPage(i))
          ) {
            var o = i.getElementsByClassName(
              "ladi-gallery-control-item"
            ).length;
            i.setAttribute("data-max-item", o),
              i.setAttribute("data-runtime-id", e.randomString(10));
            var r = function (t) {
            ...
            for (
              var c = i.getElementsByClassName("ladi-gallery-view-arrow"),
                u = 0;
              u < c.length;
              u++
            )
            ...
            var d = function (t) {
              ...
              s = function (t) {
                if (
                  ...
                  isEmptyLadiPage(e.runtime.timeout_gallery[a]) &&
                    ((e.runtime.current_element_mouse_down_gallery_view = a),
                    (e.runtime.current_element_mouse_down_gallery_view_position_x =
                      t.pageX),
                    (e.runtime.current_element_mouse_down_gallery_view_position_y =
                      t.pageY));
                }
              },
              c = function (t) {
        ...
        G = function (t, i) {
          if (
            (isEmptyLadiPage(e.runtime.timenext_carousel[t]) ||
            ...
            if (!isEmptyLadiPage(a)) {
              ...
              if ("carousel" == n.type) {
                ...
                i && P.style.removeProperty("transition-duration");
                var L =
                  1e3 *
                  (parseFloatLadiPage(
                    getComputedStyle(
                ...
                if (
                  ...
                  (u =
                    ...
                    d < 0 && (d = 0),
                    d > m - 1 && (d = m - 1);
                  var h = e.getElementBoundingClientRect(a);
                  (_ =
                    -(_ = h.x + d * u - h.x - (a.clientWidth - u) / 2) > 0
                      ? 0
                      : -_) < (f = -(s - a.clientWidth)) && (_ = f),
                    P.style.setProperty("left", _ + "px"),
                ...
                if (n["option.meta_data.version"] == e.const.META_VERSION.two) {
                  if (
                    n[
                      e.runtime.device + ".option.carousel_setting.display_type"
                    ] == e.const.CAROUSEL_DISPLAY_TYPE.horizontal
                  ) {
                    if (
                      ((s =
                    ...
                    (g =
                      parseFloatLadiPage(
                        e.runtime.eventData[t][
                          e.runtime.device + ".option.carousel_crop.margin_item"
                        ]
                      ) || 0),
                      (u =
                        parseFloatLadiPage(
                  ...
                  if (
                    n["option.carousel_setting.autoplay_type"] ==
                      e.const.CAROUSEL_AUTOPLAY_TYPE.type_ab &&
                    (i ? d++ : l ? d++ : d--, d < 0 && (d = 0), d >= m)
                  )
                    return void r.classList.add("opacity-0");
                  n["option.carousel_setting.autoplay_type"] ==
                    e.const.CAROUSEL_AUTOPLAY_TYPE.type_abab &&
                    (i ? (d > m - 2 ? (d = 0) : d++) : l ? d++ : d--,
                    d < 0 && (d = 0),
                    d > m - 1 && (d = m - 1)),
                    n["option.carousel_setting.autoplay_type"] ==
                      e.const.CAROUSEL_AUTOPLAY_TYPE.type_abba &&
                      (i
                        ? l
                          ? d > m - 2
                            ? ((d = m - 2), (l = !1))
        ...
        z = function (t) {
          if (
            e.runtime.isClient &&
            !e.runtime.isDesktop &&
            !isEmptyLadiPage(e.runtime.bodyFontSize)
          ) {
            var i =
        ...
        J = function (t, i) {
          ...
          K(l, r), isFunctionLadiPage(i) && i(l);
        },
        Z = function (i, a, n, o) {
          if ("form" == a) {
            ...
            if (!isEmptyLadiPage(r) && r["option.is_add_to_cart"]) {
              ...
              if (
                !isEmptyLadiPage(l) &&
                (!n ||
                  isEmptyLadiPage(e.findAncestor(l, "ladi-collection-item")))
              ) {
                        ...
                        e.showParentVisibility(d, function () {
                          ...
                          for (f = 0; f < v.length; f++) {
                            ...
                            (u =
                              ...
                              isNullLadiPage(u) &&
                                ((p = P[1]), isEmptyLadiPage(p) || (u = X(p))),
                              K(v[f], u);
                          }
                          if (
                            (e.updateProductVariantSelectOptionFirst(r, s, d),
                            s["option.product_variant_type"] !=
                            ...
                            d.style.setProperty("height", "auto"),
                              ...
                              i > 0 &&
                                t != i &&
                                (d.style.setProperty("height", i + "px"),
                                e.updateHeightElement(!0, d, l, t, i));
                          else if (
                            !isEmptyLadiPage(r["option.product_variant_id"])
                          )
                            for (var h = 0; h < y.length; h++) {
                              var E = y[h].querySelector(
                                'option[data-product-variant-id="' +
                                  r["option.product_variant_id"] +
                                  '"]'
                              );
                              isEmptyLadiPage(E) ||
                                y[h].value == E.getAttribute("value") ||
                                ((y[h].value = E.getAttribute("value")),
                                e.fireEvent(y[h], "change"));
                            }
                        });
                      }
                    }
            ...
            if (
              ...
              if (isEmptyLadiPage(r)) {
                ...
                for (d = 0; d < c.length; d++)
                  (r = e.findAncestor(c[d], "ladi-collection-item")),
                    isEmptyLadiPage(r) &&
                      ((s = e.runtime.eventData[c[d].id]),
                      isEmptyLadiPage(s) ||
        ...
        tt = function (i, a, n, o, r, l, d, s) {
          ...
          if (!isEmptyLadiPage(c)) {
            ...
            if (l) y = r.product[u];
              ...
              if (
                isEmptyLadiPage(c) ||
                isEmptyLadiPage(c["option.product_type"]) ||
                isEmptyLadiPage(c["option.product_id"]) ||
                isEmptyLadiPage(u)
              )
                return;
              ...
              if (
                ...
                (a &&
                  (P = !(function () {
                    for (var t = !1, i = 0; i < g.length; i++) {
                      ...
                      if (
                        "form" == a.type &&
                        a["option.product_type"] == c["option.product_type"] &&
                        a["option.product_id"] == c["option.product_id"]
                      ) {
                        t = !0;
                        break;
                      }
                ...
                if (
                  ...
                  return;
                var L = e.generateVariantProduct(
                  c,
                  !1,
                  null,
                  null,
                ...
                isObjectLadiPage(L) &&
                  (v = e.getProductVariantId(d.target, L.product));
              }
              if (
                _ ===
                (y = (f = e.generateProductKey(
                  !0,
                  _,
                  !0,
                  c,
              ...
              if ("form" == m && c["option.is_add_to_cart"])
                return (
                  (c["option.product_id"] = o.product_id),
                  (c["option.product_variant_id"] = o.product_variant_id),
                  void Z(i, m, !1, !0)
                );
              if (!p) return;
              y =
            ...
            if ("image" == m) {
              if (((h = document.getElementById(i)), isEmptyLadiPage(h)))
                return;
              (A = e.getOptimizeImage(
                y,
                h.clientWidth,
                h.clientHeight,
                !0,
              ...
              (T = isEmptyLadiPage(A)
                ...
                : "#" +
                  ...
                  A +
                  '");}'),
                e.createStyleElement(E, T);
            }
            if ("gallery" == m) {
              if (!isArrayLadiPage(y)) return;
              if (((h = document.getElementById(i)), isEmptyLadiPage(h)))
                return;
              if (n && "true" == h.getAttribute("data-loaded"))
                return void $(h, f, c);
              for (
                var w = h.getElementsByClassName("ladi-gallery-view")[0],
                  S = h.getElementsByClassName("ladi-gallery-view-item");
                S.length < y.length;
                ...
                h.getElementsByClassName("ladi-gallery-view")[0].appendChild(O);
              }
              for (; S.length > y.length; )
                S[S.length - 1].parentElement.removeChild(S[S.length - 1]);
              for (
                var C = h.getElementsByClassName("ladi-gallery-control-item"),
                  I = function (t) {
                    U(t, h);
                  };
                C.length < y.length;
              ...
              var k = h.getElementsByClassName("ladi-gallery-control-item")[0];
              y.forEach(function (a, n) {
                ...
                h.setAttribute("data-max-item", y.length),
                h.setAttribute("data-loaded", !0),
                e.createStyleElement(E, D);
            }
          }
        },
        et = function () {
          ...
          for (
            ...
            for (
              ...
              -1 != t.indexOf(v[P].getAttribute("name")) &&
                (v[P].addEventListener("change", y),
                v[P].addEventListener("input", y));
        },
        it = function (t) {
        ...
        rt = function (t, i, a) {
          ...
          if (
            ...
            if ("popup" == n.type) {
              ...
              (d = (l = ot(t)).isCurrentPopup), (s = l.isCurrentSection);
              [
                "width",
                "height",
                "position",
          ...
          LadiPageShopping.push(function () {
            ...
            g.forEach(function (i) {
              ...
              isEmptyLadiPage(n)
                ? ((function (t, i, a, n, o, r) {
                        ...
                        (e.runtime.list_scroll_func[t] = function () {
                          if (
                            ...
                            o == e.const.VIDEO_TYPE.youtube &&
                              ...
                              (d.innerHTML += i),
                              e.runEventPlayVideo(l, o, r, !0, !0, !1)),
                      ...
                      e.runTimeout(function () {
                        a.forEach(function (i) {
                          if (
                            ...
                            (isNullLadiPage(i.collapse_start_is_show) ||
                  ...
                  R(i, null, a.type, a["option.countdown_item_type"]),
                  (function (t, i, a, n) {
                    if ("section" == i) {
                                ...
                                if (
                                  ...
                                  if (
                                    ...
                                    if (-1 != r) {
                                      ...
                                      -1 != m &&
                                        (p = e.runtime.tmp.cart[m].quantity),
                                        c > s + p && (s = c - p),
                                        1 ==
                                          n.product.variants[r]
                                            .inventory_checked &&
                  ...
                  (function (t, i, a, n) {
                    if ("survey" == i) {
                      ...
                      if (!isEmptyLadiPage(o)) {
                        ...
                        for (
                          isEmptyLadiPage(l) ||
                            l.addEventListener("change", function (i) {
                          ...
                          p.push(d[T].getElementsByTagName("input")[0].value),
                            A(d[T]);
                            ...
                            if (
                              ...
                              if (
                                ...
                                var S = e.findAncestor(o, "ladi-popup"),
                                  ...
                                  I = null;
                                isEmptyLadiPage(S)
                                  ? isEmptyLadiPage(O) || (I = O.id)
                                  : (I = (S = e.findAncestor(S, "ladi-element"))
                                      .id),
                                  isEmptyLadiPage(I) ||
                                    f.push({
                                      action_type: e.const.ACTION_TYPE.complete,
                  ...
                  for (
                    ...
                    if (g < 0) {
                      ...
                      "true" != o.getAttribute("data-end") &&
                        ...
                        C(o, i["option.data_event"], {
                          action_type: e.const.ACTION_TYPE.complete,
                        }),
                        e.runEventTracking(o.id, { is_form: !1 }));
                    }
                    for (
                      var _ = e.getCountdownTime(g),
              ...
              if ("carousel" == i.type) {
                ...
                if (!isEmptyLadiPage(a)) {
                  ...
                  if (
                    ...
                    isEmptyLadiPage(i["option.meta_data.version"]) &&
                      -(
                        (parseFloatLadiPage(
                      ...
                      a
                        .getElementsByClassName("ladi-carousel-arrow-right")[0]
                        .classList.remove("opacity-0"),
                    i["option.meta_data.version"] == e.const.META_VERSION.two)
                  ) {
                    i[
                      e.runtime.device + ".option.carousel_setting.display_type"
                    ] == e.const.CAROUSEL_DISPLAY_TYPE.horizontal &&
                ...
                if (!isEmptyLadiPage(n)) {
                  ...
                  r == e.const.TOOLTIP_POSITION.top_middle &&
                    ...
                    r == e.const.TOOLTIP_POSITION.right_bottom &&
                      (d += "-right-bottom"),
                    o == e.const.TOOLTIP_TYPE.info && (d += "-t-info"),
                    o == e.const.TOOLTIP_TYPE.success && (d += "-t-success"),
                    o == e.const.TOOLTIP_TYPE.error && (d += "-t-error"),
                    o == e.const.TOOLTIP_TYPE.notice && (d += "-t-notice"),
                    l == e.const.TOOLTIP_SIZE.small && (d += "-s-small"),
                    l == e.const.TOOLTIP_SIZE.medium && (d += "-s-med"),
                    l == e.const.TOOLTIP_SIZE.big && (d += "-s-big"),
                    (d += "-hint-anim-d-short"),
                    i.classList.add(d);
                }
              }
                    ...
                    if (!isEmptyLadiPage(m)) {
                      ...
                      if (0 != g.length) {
                          ...
                          h = function (t, i) {
                            _ ||
                              (isEmptyLadiPage(e.findAncestor(t, "type"))
                                ...
                                : (v(t.querySelectorAll("i")[0], t, !1, i),
                          ...
                          E = function (s) {
                            if (!_ && !isEmptyLadiPage(s)) {
                              ...
                              if (isEmptyLadiPage(e.findAncestor(s, "type")))
                                if (
                                  isEmptyLadiPage(e.findAncestor(s, "letters"))
                                )
                                  isEmptyLadiPage(e.findAncestor(s, "clip"))
                                    ? isEmptyLadiPage(
                                        e.findAncestor(s, "loading-bar")
                                      )
                                      ? (L(s, c),
                                        e.runTimeout(function () {
                                          E(c);
                        ...
                        u.parentElement.insertBefore(A, u.nextSibling),
                          ...
                          (e.runtime.list_scrolling_exec[y] = function () {
                            u.parentElement.removeChild(u),
                              ...
                              (_ = !0),
                              delete e.runtime.list_scrolling_exec[y];
                          });
                        ...
                        if (
                          ...
                          !isEmptyLadiPage(e.findAncestor(m, "type")) ||
                            !isEmptyLadiPage(
                              e.findAncestor(m, "loading-bar")
                            ) ||
                            !isEmptyLadiPage(e.findAncestor(m, "clip")))
                        ) {
                          m.innerHTML =
            ...
            (function () {
              for (
                ...
                i[a].addEventListener("mousedown", t),
                ...
                if (!isEmptyLadiPage(i)) {
                  for (
                    var n = function (t) {
                        t.addEventListener("click", function (e) {
                          if (
                            (e.stopPropagation(),
                            isObjectLadiPage(window.LadiSales))
                          ) {
                            var i = {
                            ...
                            "true" ==
                              ...
                              window.LadiSales.buyNow(i),
                              "true" ==
                                t.getAttribute("data-add-to-cart-ladisales") &&
                                isFunctionLadiPage(window.LadiSales.cartAdd) &&
                                window.LadiSales.cartAdd(i);
                          }
                        });
                      },
                      o = 0;
                  ...
                  if (isEmptyLadiPage(r)) {
                    ...
                    isEmptyLadiPage(a) || (l += "_" + a),
                      e.loadScript(
                        e.const.LADISALES_SDK,
                        { id: l, "data-time": e.runtime.timenow },
                        !0
                      );
                  }
                }
            ...
            (function () {
              document.addEventListener("mouseleave", e.runEventMouseLeave),
                document.addEventListener("mousedown", e.runEventMouseDown),
                document.addEventListener(
                  "touchstart",
                  e.runEventMouseDown,
                  e.runtime.scrollEventPassive
              ...
              var t = window;
              isObjectLadiPage(e.runtime.story_page) &&
            ...
            (e.runtime.list_loaded_func = e.runtime.list_loaded_func.concat(_)),
      ...
      (e.runtime.tmp.runDataEventNow = C),
        (e.runtime.tmp.generateLadiSaleProduct = function (t, i, a) {
          var n = function () {
              g.forEach(function (n) {
                e.runtime.eventData[n], tt(n, t, i, null, null, !1, a);
              });
            },
            o = function (t) {
                        ...
                        if (!isEmptyLadiPage(c)) {
                          ...
                          if (
                            ...
                            if (-1 != p)
                              for (var g = 0; g < m.length; g++)
                                if (
                                  m[g].id != r.id &&
                                  isEmptyLadiPage(
                                    e.findAncestor(m[g], "ladi-collection")
                                  )
                                ) {
                                    ...
                                    if (!isEmptyLadiPage(y)) {
                                      ...
                                      if (
                                        ...
                                        if (
                                          ...
                                          continue;
                                        if (
                                          ((L = u.product.variants[p]),
                                          isStringLadiPage(L.option_ids))
                                        )
                                          for (
                                            h = L.option_ids.split("/"), E = 0;
                                            E < h.length;
                                            E++
                                          )
                                      ...
                                      if (
                                        ...
                                        if (
                                          ...
                                          isEmptyLadiPage(P) ||
                                            P.getAttribute("data-store-id") !=
                                              u.store_info.id ||
                                            P.getAttribute("data-product-id") !=
                                              u.product.product_id)
                                        )
                                          continue;
                                        var A = e.getProductVariantId(r, u);
                                        if (!isEmptyLadiPage(A)) {
                                          var b = P.querySelector(
                                            'option[data-product-variant-id="' +
                                              A +
                                              '"]'
                                          );
                            ...
                            for (var T = 0; T < m.length; T++) {
                              var w = e.findAncestor(m[T], "ladi-form");
                  ...
                  isEmptyLadiPage(o) ||
                    e.showParentVisibility(o, function () {
                      ...
                      if (i != (l = l < a ? a : l)) {
                        ...
                        isEmptyLadiPage(d) &&
                          (d = e.findAncestor(o.parentElement, "ladi-section")),
                          e.updateHeightElement(!0, o, d, i, l);
                      }
                    });
                }
              }
        ...
        (e.runtime.tmp.runElementClickSelected = W),
        (e.runtime.tmp.runTrackingAnalytics = S),
        (e.runtime.tmp.runLadiSaleProductKey = tt),
        (e.runtime.tmp.eventClickGalleryControlItem = U),
        (e.runtime.tmp.runGallery = q),
        (e.runtime.tmp.setGalleryStart = j),
        (e.runtime.tmp.updateImageGalleryProduct = $),
        (e.runtime.tmp.runOptionCountdown = x),
        (e.runtime.tmp.runOptionCountdownItem = R),
        (e.runtime.tmp.getOptionLabelValue = X),
        (e.runtime.tmp.updateLabelValue = K),
        ...
        (e.runtime.tmp.showPopupX = rt),
        (e.runtime.tmp.runActionPopupX = it),
        e.runtime.is_popupx
                    ...
                    !(function (t, i) {
                      ...
                      if (
                        ("callback_request_with_option" == t &&
                          isFunctionLadiPage(
                            e.runtime.tmp[
                              "request_callback_id_" + i.callback_id
                            ]
                          ) &&
                          e.runtime.tmp["request_callback_id_" + i.callback_id](
                            i.responseText,
                            i.status,
                            i.httpRequest,
                            i.url
                        ...
                        "none" != getComputedStyle(n).display &&
                          (e.runtime.tmp.popupx_is_inline
                            ? lt(e.runtime.tmp.popupx_current_element_id, !1)
                            : rt(e.runtime.tmp.popupx_current_element_id, !1));
                      }
                      if ("set_iframe_info" == t) {
                        isEmptyLadiPage(y) &&
                          ((y = i.ladi_client_id || e.randomId()),
                          window.ladi("LADI_CLIENT_ID").set_cookie(y, 3650)),
...
var lightbox_run = function (t, e, i, a, n, o, r, l) {
    ...
    if (!isEmptyLadiPage(d)) {
      ...
      var L = function () {
        ...
        h = 0;
      L()
        ? ((h = window.scrollY), (LadiPageScript.runtime.tmp.bodyScrollY = h))
        : (h = LadiPageScript.runtime.tmp.bodyScrollY);
      var E = function () {
        s(),
    ...
    if (!isEmptyLadiPage(a)) {
      ...
      if (4 == d.length)
        ...
        for (r = 0; r < p.length; r++)
          if (isNullLadiPage(t)) {
            var L = getComputedStyle(p[r]).backgroundImage;
            (L = L || "").startsWith('url("') &&
              (L = L.substring('url("'.length)),
              L.endsWith('")') && (L = L.substring(0, L.length - '")'.length)),
              n.push(L);
          } else if (isEmptyLadiPage(t))
            p[r].style.setProperty("background-image", "none");
          else {
            var h = LadiPageScript.findAncestor(p[r], "ladi-element"),
        ...
        for (r = 0; r < _.length; r++)
          isNullLadiPage(t)
            ...
            : ((P = !1),
              -1 != l.indexOf(_[r].getAttribute("data-value")) && (P = !0),
              P
...
isArrayLadiPage(window.ladi_fbq_data) &&
  ...
  (LadiPageScript.const.DATA_TYPE = { default: "default", dataset: "dataset" }),
  ...
  (LadiPageScriptV2.prototype.loadDataset = function (t, e, i, a, n, o, r, l) {
      ...
      s = function (t, e, i) {
        return (
          isArrayLadiPage(t) &&
            ...
            !isEmptyLadiPage(i) &&
            t.sort(function (t, a) {
              return d.const.SORT_BY_TYPE.asc == i
                ? t[e] > a[e]
                  ? 1
                  : -1
                : t[e] < a[e]
    ...
    if (d.runtime.tmp.dataset_check_load)
      ...
      if (isEmptyLadiPage(t)) {
        ...
        if (e.length != d.const.DATASET_ID_LENGTH) return;
                    ...
                    if (i + 1 < t.length) {
                      ...
                      LadiPageScript.runtime.tmp.timeout_notify[e] =
                        LadiPageScript.runTimeout(function () {
                          v(),
                            (LadiPageScript.runtime.tmp.timeout_notify[e] =
                              LadiPageScript.runTimeout(L, 500));
                        }, g);
                    } else P(t);
                  };
                LadiPageScript.runtime.tmp.timeout_notify[e] =
